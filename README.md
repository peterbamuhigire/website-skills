...
| 2026-02-22 | new-project.sh | Enhanced with multi-language directories (docs/en/, docs/fr/, docs/sw/), template copying from submodule, i18n config, SEO config, categorised photo-bank subdirectories, updated CLAUDE.md with i18n support |
| 2026-02-22 | new-project.ps1 | Added Windows PowerShell equivalent of new-project.sh with identical functionality |
| 2026-02-22 | prompts/ | Added prompts directory with maduuka-website-content.md for generating SaaS marketing website content from system documentation |
