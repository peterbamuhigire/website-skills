...
**CRITICAL:** Keep SKILL.md body to the essentials and **UNDER 500 LINES** (hard limit). This applies to ALL markdown files created by skills: documentation, plans, specifications, manuals, and guides.

**Documentation Standards (MANDATORY):**
- **500-line hard limit** for ALL .md files - no exceptions
- Use **two-tier structure**: High-level TOC (Tier 1) + Deep dive docs (Tier 2)
- **Smart subdirectory grouping** for related docs
- See **`doc-standards.md`** for complete requirements

Split content into separate files when approaching this limit. When splitting out content into other files, it is very important to reference them from SKILL.md and describe clearly when to read them, to ensure the reader of the skill knows they exist and when to use them.
...
- **Skill authoring best practices**: See references/skill-authoring-best-practices.md for end-to-end guidelines
