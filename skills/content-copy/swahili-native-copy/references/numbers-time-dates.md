...
**Read this when**: You are writing prices, opening hours, dates, deadlines, or any number in Kiswahili copy.
...
Number agreement, the Swahili clock, days, months, and date conventions distilled from Joan Russell, *Swahili (Teach Yourself)*, *Swahili (Spoken World)* (Living Language), and *Swahili Grammar (Sarufi ya Kiswahili)* (Almasi, Fallon et al.); currency conventions per Tanzanian and Kenyan usage. Telling-time fractions, ordinals concord, and price/money vocabulary added in 2026 from the *Rough Guide Phrasebook — Swahili* (Lexus) and Peter M. Wilson, *Simplified Swahili*. Sector lexicon and Tanzania/Kenya calibration: [service, hospitality and sector lexicon](service-hospitality-and-sector-lexicon.md).
