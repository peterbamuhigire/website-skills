...
- `references/content-distribution.md` — why content grows a business, create-versus-distribute effort split, repurposing chain, distribution checklist (email, LinkedIn, Q&A sites, communities, slide platforms, video, guest posting), YouTube blog amplifier loop
...
| `references/content-distribution.md` | After drafting — plan distribution across 9 channels (email, LinkedIn, Quora, communities, SlideShare, YouTube, guest posting); set the create-versus-distribute effort split; build the repurposing plan for each article |
