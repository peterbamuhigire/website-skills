...
- `references/ecommerce-design-ux.md` — Task-organised reference for store scoping and payment routes, checkout rules, product photography, reviews and ratings, search and faceted filtering, common design mistakes, conversion and A/B testing method, trust and delivery-cost strategy, and the thank-you page as a conversion tool. Consult this file when designing product pages, checkout flows, search/filter UX, or planning a CRO programme.
