...
Public evidence: `skills/orchestration/africa-excellence/` skill + 6 references;
...
5. Calibration pass: two operators blind-score the four worked
   examples in `skills/quality-gates/design-quality-score/references/scored-examples.md`
