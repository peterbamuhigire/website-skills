---
name: form-ux-design
description: Research-backed form UX for static websites — contact forms, newsletter, booking, multi-step. Three dimensions: Words > Layout > Flow. Covers field types, label placement, validation, error messages, and conversion stats. Use when building any form on a website.
---
