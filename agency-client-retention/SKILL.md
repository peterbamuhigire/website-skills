...
description: Client retention, retainer architecture, recurring-revenue operations, post-launch reviews, expansion offers, and the agency's internal operating model. Use when productising retainers, planning post-launch review cadence, designing expansion offers, building monthly client reports, setting internal OKRs, prioritising automation, defining capacity math, or running the agency itself as a subscription business. Covers the 5 productized retainers, the 30/90/quarterly/annual review cycle, the 9-offer expansion matrix, the subscription P&L (Tzuo), the 9 subscription business models (Warrillow), OKRs and CFRs (Doerr), the hybrid agency operating model (Roetzer), and the automation backlog discipline. Designed for premium $12k–$45k engagement agencies converting to $750–$3,000/month retainers.
---
